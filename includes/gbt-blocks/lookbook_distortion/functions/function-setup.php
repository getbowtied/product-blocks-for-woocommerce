...
//==============================================================================
add_action( 'admin_init', 'pbfw_lookbook_distortion_editor_assets' );
function pbfw_lookbook_distortion_editor_assets() {
	wp_enqueue_script(
...
register_block_type( 'getbowtied/lookbook-distortion-product', array(
	...
	'render_callback' => 'pbfw_render_frontend_lookbook_distortion_product',
) );