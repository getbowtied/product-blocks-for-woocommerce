		...
		'getbowtied/products-slider',
		{
			...
			edit: function( props ) {
				...
				function renderResults() {
					...
					if ( productElements.length == 0 ) {
						productElements.push(
							el(
								"div",
								{ className: "gbt_18_editor_slide_placeholder_content_item", key: "gbt_18_slide_placeholder_content_item"},
								el(
									"div",
									{ className: "gbt_18_editor_slide_placeholder_content_left", key: "gbt_18_editor_slide_placeholder_content_left"},
								...
								el(
									"div",
									{ className: "gbt_18_editor_slide_placeholder_content_right", key: "gbt_18_editor_slide_placeholder_content_right"},
				...
				function _getQueryOrder() {
					if ( attributes.queryOrder.length < 1) {
						return '';
					}
					let order = '';
